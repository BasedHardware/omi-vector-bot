...
const RAILS_FAQ = [
  ...
  'BYOK means they use their own API key. The docs privacy page says that wearable app version then stores data on the device and does not collect it at Omi. Do not invent a settings path, a price, or how it compares with a paid plan.',
